...
//     <div>
//       {/* Header Section */}
//       <div className="bg-gradient-to-b from-white to-[#26E8AC] pt-[130px] pb-[50px] text-center">
//         <h1 className="text-5xl font-bold text-white">Commission Disclosures</h1>
//       </div>

//       {/* Table Section */}
//       <div className="container mx-auto px-4 md:px-32 py-12">
//       <h1 className="text-2xl text-center font-bold text-[var(--primary)] mb-2">Commission Disclosure under SEBI Circular SEBI/IMD/CIR No.4 /168230/09</h1>
