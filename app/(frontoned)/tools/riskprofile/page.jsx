...
Here are the answers you provided:
    ...
    return (
        <div className="max-w-3xl mx-auto my-40  p-6 bg-white shadow-lg rounded-lg">
            <Toaster />
            {isModalOpen && (
                <div className="fixed z-50 inset-0 flex items-center justify-center bg-[oklch(0 0 0 / 0.66)] bg-opacity-10">
