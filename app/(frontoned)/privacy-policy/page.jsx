...
//         <div className="  mb-8">
//               <h1 className="text-5xl pb-5 font-bold text-white">Privacy Policy</h1>
//               {/* <Breadcrumb>
//                 <BreadcrumbList className="text-white text-center items-center">
//                   <BreadcrumbItem>
//                     <BreadcrumbLink className="text-center items-center text-white" href="/">
//                       Home
//                     </BreadcrumbLink>
//                   </BreadcrumbItem>
//                   <BreadcrumbSeparator />
