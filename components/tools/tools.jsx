    ...
    <div className="flex flex-wrap items-center animate-fadeInUp pl-3">
      <div className="w-full lg:w-3/4 md:w-2/3">
        <div className="mb-6 ">
                  ...
                  <h2 className="text-[32px] sm:text-[36px] md:text-[42px] leading-[40px] sm:leading-[46px] md:leading-[52px] text-white uppercase font-extrabold mb-0">
                    investors Corners
                  </h2>
                </div>
      </div>
      <div className="w-full lg:w-1/4 md:w-1/3 pl-4 md:pl-0 md:text-right">
        <div className="md:mb-8">
          <Link href="/contactus">
          <Button className="text-white px-5 py-5 border-2 border-white text-xl cursor-pointer">Contact Us</Button>
          </Link>
        </div>
      </div>
    </div>
