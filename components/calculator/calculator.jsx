              ...
              <div className="input-fields mt-5">
                ...
                <div className="flex justify-center space-x-4 mb-8">
                  <button
                    ...
                    className={`py-4 px-10 md:px-20 font-bold ${
                      isMonthlySip
                        ? "rounded-lg bg-[var(--rv-bg-secondary)] text-white"
                ...
                <div className="input-fields mt-5 mb-10">
                  {isMonthlySip ? (
                    <div>
                      <div className="flex justify-between">
                        <h5 className="font-medium text-white">Monthly investment (₹)</h5>
                        <div className="">
                          ...
                          <input
                            ...
                            className="ml-2 px-2 font-bold text-lg text-white w-20 border-none"
                          />
                        </div>
                      </div>
                      <Input
                    ...
                    <div>
                      <div className="flex justify-between">
                        <h5 className="font-medium text-white">Total investment (₹)</h5>
                        <div>
                          <span className="font-semibold text-white">
                            ₹
                          </span>
                          <input
                            ...
                            className="ml-2 px-2 font-bold text-lg text-white w-16  border-none"
                          />
                        </div>
                      </div>
                      <Input
                  ...
                  <div className="items-center mt-5">
                    <div className="flex justify-between">
                      <h5 className="font-medium text-white">Time period (Year)</h5>
                     <div>
                     ...
                     <div><input
                        ...
                        className="ml-2 px-2 font-bold text-lg text-white w-10  border-none"
                      />
                        <span className="font-semibold text-white">
                            YRS
                          </span></div>
                  ...
                  <div className="items-center mt-5">
                    <div className="flex justify-between">
                      <h5 className="font-medium text-white">Expected Return (%)</h5>
                     <div>
                     <input
                        type="text" // Change type to number for better input handling
                ...
                {isSubmitted ? (
                  <div className="mb-5 flex justify-between">
                    <div className="space-x-2">
                      <Button
                        ...
                        className=" bg-[var(--rv-bg-secondary)] "
                      >
                        Invest now
                      </Button>
                    </div>
                  ...
                  >
                    <DialogTrigger asChild>
                      <Button className=" bg-[var(--rv-secondary)] text-white">Invest Now</Button>
                    </DialogTrigger>
              ...
              {result && (
                  <div className="mt-4 px-12">
                    <div className="mb-2 text-left flex items-center justify-start gap-3">
                      <p className="text-white text-2xl">Your Invested Amount will be </p>{" "}
                      <p className="text-2xl font-extrabold text-[var(--rv-secondary)]">
                        ₹{result?.totalInvestment?.toLocaleString()}
                      </p>
                    </div>
                    <div className="mb-5 text-left flex items-center justify-start gap-3">
                      <p className="text-white text-2xl">Your Estimated Return will be </p>
                      <p className="text-2xl font-extrabold text-[var(--rv-secondary)]">
                        ₹
                        {Math.floor(
