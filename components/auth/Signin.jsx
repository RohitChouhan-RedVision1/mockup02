                    ...
                    {roles.map((role) => (
                        <button
                            ...
                            className={`mt-5 tracking-wide font-semibold w-full py-2 rounded-lg transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none ${selectedRole !== role
                                ...
                                : "bg-[var(--primary)] text-gray-100 hover:bg-gray-700"
                                }`}
                    ...
                    <div className="w-full flex-1 mt-8">
                        <div className="mx-auto max-w-xs">
                            <form onSubmit={handleSubmit}>
                                ...
                                />
                                <button className="mt-5 tracking-wide font-semibold bg-[var(--primary)] text-gray-100 w-full py-4 rounded-lg hover:bg-gray-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                                    {loading ? (
                                        <div role="status">
