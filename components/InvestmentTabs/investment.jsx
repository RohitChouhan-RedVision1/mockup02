          ...
          {Object.keys(tabData).map((tab) => (
            <Button
              ...
              className={`px-4 py-4 rounded-lg mb-4 cursor-pointer section3cardheading ${
                activeTab === tab ? "bg-[#C59f4a] text-white" : "bg-[#1e3b4a] text-white"
              }`}
              ...
              <div key={index} className="p-4">
                <Link href={card.link}>
                  <div className="relative rounded-lg overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-[100px] bg-[#0E314DD9] p-5 text-center section3cardheading text-white font-semibold">
                      {card.title}
                    </div>
                  </div>
                </Link>
            ...
            {activeCards.map((card, index) => (
              <div key={index} className="p-4 justify-center items-center h-[400px] max-w-[300px]">
                <Link href={card.link}>
                  <div className="relative rounded-lg overflow-hidden">
                    <img src={card.img} alt={card.title} className="w-full h-[400px] object-cover" />
                    <div className="absolute bottom-0 left-0 right-0 h-[100px] bg-[#0E314DD9] p-5 text-center text-2xl section3cardheading text-white font-semibold">
                      {card.title}
                    </div>
                  </div>
                </Link>
